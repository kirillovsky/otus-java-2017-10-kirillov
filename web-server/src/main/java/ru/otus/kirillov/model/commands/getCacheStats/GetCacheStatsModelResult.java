 ...
 */
public final class GetCacheStatsModelResult implements ModelResult {
    ...
    private GetCacheStatsModelResult(long cacheHit, long cacheMiss, long cacheSize) {
        this.cacheHit = cacheHit;
        this.cacheMiss = cacheMiss;
        this.cacheSize = cacheSize;
    }

    public static GetCacheStatsModelResult of(CacheStatistics stats) {
        CommonUtils.requiredNotNull(stats);
        return new GetCacheStatsModelResult(stats.getCacheHit(), stats.getCacheMiss(), stats.getCacheSize());
    }
