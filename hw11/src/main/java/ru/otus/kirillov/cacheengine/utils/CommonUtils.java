package ru.otus.kirillov.cacheengine.utils;
...
public final class CommonUtils {
    ...
    public static abstract class TokenType<T> {
        ...
        public Class<T> getType() {
            ...
            return (Class<T>) ((ParameterizedType) parameterized.getActualTypeArguments()[0]).getRawType();
        }
    }
    ...
    public static <T> T returnIfNotNull(T value, String msg) {
